...
class DriverFeedBackProvider with ChangeNotifier {
  ...
  getFeedBack() async {
    String? cachedRating =
        await locator<CacheHelper>().getData(key: "driverFeedBackRating");
    ...
    String? cachedFeedBack =
        await locator<CacheHelper>().getData(key: "driverFeedBackText");
  ...
  updateFeedBack({required BuildContext context}) async {
    await locator<CacheHelper>().saveData(
      key: "driverFeedBackText",
      value: feedBackController.text,
    );
    await locator<CacheHelper>().saveData(
      key: "driverFeedBackRating",
